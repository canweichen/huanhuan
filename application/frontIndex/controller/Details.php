...
class Details extends Controller
{
    ...
    {
        return $this->fetch("allDetails/type");
    }
    public function auction(){
        return $this->fetch("allDetails/auction");
    }
    ...
    public function type_data(){
        ...
        $tradesortData=Db::table('t_trade')->paginate(20);


//        $province_arr = db("provinces")->select();
        // echo json_encode([$type_data,$prefectural_data,$com_data]);
        echo json_encode([$type_data,$prefectural_data,$tradesortData]);
...
//        var_dump($issue_trade);exit;
        ...
        return $this->fetch("allDetails/issue_trade");
    }
    //用户发布商品分页
...
//        cookie('tradeid',$tradeid);  //设置cookie
        ...
        return $this->fetch("allDetails/details");
